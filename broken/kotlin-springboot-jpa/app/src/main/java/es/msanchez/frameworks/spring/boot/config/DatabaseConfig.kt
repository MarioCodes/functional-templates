...
@EnableJpaRepositories(basePackages = ["es.msanchez.frameworks.spring.boot.dao"])
class DatabaseConfig {
    ...
    fun entityManagerFactory(dataSource: DataSource,
        ...
        entityManagerFactoryBean.setPackagesToScan("es.msanchez.frameworks.spring.boot.**")
