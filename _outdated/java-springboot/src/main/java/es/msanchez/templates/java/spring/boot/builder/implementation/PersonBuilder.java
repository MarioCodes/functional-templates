package es.msanchez.templates.java.spring.boot.builder.implementation;

import es.msanchez.templates.java.spring.boot.builder.abstraction.AbstractBuilder;
import es.msanchez.templates.java.spring.boot.entity.Person;
